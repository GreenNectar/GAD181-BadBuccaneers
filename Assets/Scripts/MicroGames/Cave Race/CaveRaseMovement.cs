...
public class CaveRaseMovement : MicroGamePlayerController
{
    ...
    public float sphereRadius = 0.7f;
    ...
    void Update()
    {
        isGrounded = Physics.CheckSphere(groundCheckObj.position, sphereRadius, LayerMask.GetMask("Ground"), QueryTriggerInteraction.Ignore);
        ...
        if (player.GetButtonDown("Jump")  && dead == false)
        {
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawSphere(groundCheckObj.position, sphereRadius);
    }
}
