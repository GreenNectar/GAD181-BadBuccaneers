...
public static class Mathfx
{
    ...
    #region Mathfx interpolations http://wiki.unity3d.com/index.php?title=Mathfx
    ...
    {
        return new Vector2(Sinerp(start.x, end.x, value), Sinerp(start.y, end.y, value));
    }
    ...
    // This was a custom one as I need quaternions too -_-
    public static Quaternion Sinerp(Quaternion start, Quaternion end, float value)
    {
        return Quaternion.Lerp(start, end, Mathf.Sin(value * Mathf.PI * 0.5f));
    }
    ...
    {
        return Quaternion.Lerp(start, end, 1f - Mathf.Cos(value * Mathf.PI * 0.5f));
    }
