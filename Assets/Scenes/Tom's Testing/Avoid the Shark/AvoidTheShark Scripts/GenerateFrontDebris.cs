...
public class GenerateFrontDebris : MonoBehaviour
{
    ...
    IEnumerator DebrisDrop()
    {
        while (debrisCount < debrisMax)
        {
            ...
            Instantiate(theDebris[Random.Range(0, 3)], new Vector3(xPos, yPos, Random.Range(zPosMin, zPosMax)), Quaternion.Euler(0, debrisYRotation, 0));
